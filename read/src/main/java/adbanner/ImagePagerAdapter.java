...
public class ImagePagerAdapter extends BaseAdapter {
    ...
    public ImagePagerAdapter(Context context, List<String> imageIdList,
        ...
        options = new DisplayImageOptions.Builder()
                .showStubImage(R.drawable.default_big_icon) // 设置图片下载期间显示的图片
                .showImageForEmptyUri(R.drawable.default_big_icon) // 设置图片Uri为空或是错误的时候显示的图片
                .showImageOnFail(R.drawable.default_big_icon) // 设置图片加载或解码过程中发生错误显示的图片
